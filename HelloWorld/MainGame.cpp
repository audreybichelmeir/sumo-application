...
void MainGameEntry( PLAY_IGNORE_COMMAND_LINE )
{
	...
	Play::Play::CreateManager( DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_SCALE );GetGameObject(id_fan).velocity = {0,3};
	Play::GetGameObject(id_fan).animSpeed = 1.0f;
}

// Called by PlayBuffer every frame (60 times a second!)
bool MainGameUpdate( fHandlePlayerControlsloat elapsedTime )
{
